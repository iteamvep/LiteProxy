 ...
 */
package org.iharu.proxy.core.config;
...
public class ProxyConfig implements Serializable {
  ...
  private org.littleshoot.proxy.ChainedProxyType proxyType;
  private String host;
  private int port;
  private String user;
  private String pwd;
  ...
  public ProxyConfig(ChainedProxyType proxyType, String host, int port) {
    this.proxyType = proxyType;
    this.host = host;
    this.port = port;
  }

  public ProxyConfig(ChainedProxyType proxyType, String host, int port, String user, String pwd) {
    this.proxyType = proxyType;
    this.host = host;
    this.port = port;
    this.user = user;
  ...
  public void setChainedProxyType(ChainedProxyType proxyType) {
    this.proxyType = proxyType;
  }
